...
from .const import (
    ...
    SERVICE_ADJUST_INVENTORY_STOCK,
)
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    if not hass.services.has_service(DOMAIN, SERVICE_ADD_GROCERY_ITEM):
        ...
        hass.services.async_register(
            DOMAIN,
            SERVICE_ADJUST_INVENTORY_STOCK,
            lambda call: async_handle_adjust_inventory_stock(hass, call),
            schema=ADJUST_INVENTORY_STOCK_SCHEMA,
        )
...
async def async_unload_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    if unloaded:
        ...
        if not hass.data[DOMAIN]:
            ...
            hass.services.async_remove(DOMAIN, SERVICE_ADJUST_INVENTORY_STOCK)
    return unloaded
